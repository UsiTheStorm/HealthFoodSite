...
function cardsFunc() {
  ...
  class MenuCard {
    ...
    render() {
      ...
      this.classes.forEach(function () {
        let className = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'menu__item';
        return newCard.classList.add(className);
      });
      newCard.innerHTML = `
